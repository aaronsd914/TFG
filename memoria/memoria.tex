...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \node at (3,0.9) {\textbf{Unitarias: 750}};
...
\begin{table}[H]
  ...
  \begin{tabular}{llcc}
    ...
    \midrule
    Unitario backend    & pytest 9       & 239  & $>$ 80\,\% \\
...
\begin{table}[H]
  ...
  \begin{tabular}{lcp{6cm}}
    ...
    test\_albaranes.py     & 34 & Crear, listar, fianza auto, estados, movimiento pendiente, PDF, líneas \\
    test\_analytics.py     & 31 & summary, compare, RFM, cesta, Holt, export/pdf con Groq mockeado \\
    test\_transportes.py   & 34 & Almacén, rutas, asignar, liquidar \\
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{lX}
    ...
    Conciliación bancaria automática & Implementar integración con Open Banking PSD2 para detectar automáticamente cobros recibidos y conciliarlos con albaranes pendientes de pago. \\
    \bottomrule
  \end{tabularx}
\end{table}
